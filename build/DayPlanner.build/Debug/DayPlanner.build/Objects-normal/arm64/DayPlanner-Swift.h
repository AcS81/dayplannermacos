...
#ifndef DAYPLANNER_SWIFT_H
#define DAYPLANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DayPlanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10DayPlanner13SpeechService")
@interface SpeechService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class SFSpeechRecognizer;
@interface SpeechService (SWIFT_EXTENSION(DayPlanner)) <SFSpeechRecognizerDelegate>
- (void)speechRecognizer:(SFSpeechRecognizer * _Nonnull)speechRecognizer availabilityDidChange:(BOOL)available;
@end

@class AVSpeechSynthesizer;
@class AVSpeechUtterance;
@interface SpeechService (SWIFT_EXTENSION(DayPlanner)) <AVSpeechSynthesizerDelegate>
